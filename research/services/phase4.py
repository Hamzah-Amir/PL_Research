...
def _h10_cells(xray_by_kw: dict, launch_keywords=None) -> Dict[str, object]:
    ...
    filling the pre-styled data rows. The KW1/KW2/KW3 labels and Amazon URLs use
    the Phase-2 launch keywords (top 3) when provided — NOT the uploaded file
    names; the Xray files supply only the product rows, in upload order."""
    import pandas as pd
