...
Phase 1 ends when the user selects one ASIN from the output Excel. That ASIN is the input for Phase 2. Phases 2+ are not yet implemented and must not be started until Phase 1 is signed off.
